#!/bin/bash
# ==========================================================================
# Deployment Script for CryptoCurrent
# ==========================================================================

echo "=== Deploying CryptoCurrent to GitHub Pages ==="
echo ""
...
git add .
git commit -m "Initial commit - News aggregator workspace for CryptoCurrent"
